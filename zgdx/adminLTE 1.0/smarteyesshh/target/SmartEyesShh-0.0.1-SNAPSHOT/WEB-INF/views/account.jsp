            ...
            <div class="sysmg-rbox " >
                ...
                <div class="sysmg-cp " style="display: none">
                    ...
                    <div class="item">
                        ...
                        <input type="password" name="cpuser1" class="fl"/>
                        <%--<span class="label alabel"><a href="#">忘记密码?</a></span>--%>
                    </div>
                    <div class="item">
                        <span class="label">新的登录密码 :  </span>
                        <input type="password" name="cpuser2" class="fl"/>
                    </div>
                    <div class="item">
                        <span class="label">确认新的登录密码 :</span>
                        <input type="password" name="cpuser3" class="fl" />
                    </div>
...
//                data:{"usernick":newuser[0],"username":newuser[1],"password":newuser[2]},
                    success: function (res) {
                        ...
                        $(".sysmg-getuser").find("span.content").eq(2).text("" + phone);
