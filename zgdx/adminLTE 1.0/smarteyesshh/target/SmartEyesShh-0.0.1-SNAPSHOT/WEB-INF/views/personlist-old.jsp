    ...
    <div class="jilu clearfix">
        ...
        <div class="mytable">
            <div class="tabhead row">
                <span class="col-lg-7 col-md-7 col-xs-7">目标人员信息</span>
            ...
            <div class="tabcont row">
                <div class="lie clearfix">
                    ...
                    <span class="col-lg-1 col-md-1 col-xs-1" style="padding: 0 0 0 3%;">涉案类型</span>
                    <span class="col-lg-2 col-md-2 col-xs-2">查询状态</span>

                    <span class="col-lg-1 col-md-1 col-xs-1">用户ID</span>
                    <span class="col-lg-1 col-md-1 col-xs-1" style="padding: 0 0 0 3%">用户姓名</span>
                ...
                <div class="xinxi">
                    <%--<div class="lie clearfix" >--%>
                        ...
                        <%--<span class="col-lg-1 col-md-1 col-xs-1" style="padding: 0 0 0 50px;">涉毒</span>--%>
